            ...
            <div class="box-header with-border">
              <div class="pull-right">
                <form method="POST" class="form-inline" id="payForm">
                  ...
                  <button type="button" class="btn btn-success btn-sm btn-flat" id="payroll"><span class="glyphicon glyphicon-print"></span> Lương bổng</button>
                  <button type="button" class="btn btn-primary btn-sm btn-flat" id="payslip"><span class="glyphicon glyphicon-print"></span> Phiếu lương</button>
                </form>
              </div>
            </div>
            <div class="box-body">
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>".number_format($deduction, 0)."</td>
                          <td>".number_format($cashadvance, 0)."</td>
