          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="position_add.php">
          		  <div class="form-group">
                  	<label for="title" class="col-sm-3 control-label">Tiêu đề vị trí</label>
                ...
                <div class="form-group">
                    <label for="rate" class="col-sm-3 control-label">Tỷ lệ mỗi giờ</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_title" class="col-sm-3 control-label">Tiêu đề vị trí</label>
                ...
                <div class="form-group">
                    <label for="edit_rate" class="col-sm-3 control-label">Tỷ lệ mỗi giờ</label>
