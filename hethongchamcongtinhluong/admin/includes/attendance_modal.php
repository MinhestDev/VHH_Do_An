    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Thêm điểm danh</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	<label for="time_out" class="col-sm-3 control-label">Giờ ra</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	<label for="edit_time_out" class="col-sm-3 control-label">Giờ ra</label>
